export const messages = {
  en: {
    ...
    server_type_hint_cloud: "Use this for Comfy Cloud. The client will authenticate with `X-API-Key` and use the Cloud job APIs.",
  ...
  zh: {
    ...
    server_type_hint_cloud: "用于 Comfy Cloud。客户端会通过 `X-API-Key` 鉴权，并走 Cloud 任务接口。",
...
messages.zh_hant = {
  ...
  server_type_hint_cloud: "用於 Comfy Cloud。客戶端會透過 `X-API-Key` 驗證，並走 Cloud 任務介面。",
